...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kFrontRightDriveAbsoluteEncoderOffsetRad = Math.toRadians(-14.2);
    public static final double kRearRightDriveAbsoluteEncoderOffsetRad = Math.toRadians(39.48);
    public static final double kRearLeftDriveAbsoluteEncoderOffsetRad = Math.toRadians(-151.77);
    public static final double kFrontLeftDriveAbsoluteEncoderOffsetRad = Math.toRadians(-44.83+180);
  ...
  public static final class Buttons {
    ...
    public static final double kSteerReduction = (1.0 / 12.8);
  ...
  public static final class PivotConstants {
    ...
    public static final double kPivotMotorSpeed = 0.6;

    //Pivot Positions
    public static final double kMaxPivotPosition = 28;
    public static final double kMinPivotPosition = 0;
    public static final double upRightIntake = 18.9;
    public static final double knockedOverIntake = 10.4;
    public static final double HighOuttake = 9.0;
    public static final double vaultIntake = 15;
    public static final double stackOuttake = 16.5;
    public static final double autoOuttake = 7;
    ...
    public static final double kP_Pivot = 0.8;
    public static final double kI_Pivot = 0.0;
    public static final double kD_Pivot = 0.03;
  ...
  public static final class ElevatorConstants {
    ...
    public static final double deadbandAngle = 0.8;

    public static final double kMaxElevatorPosition = 60;
    public static final double kMinElevatorPosition = 0;
    public static final double upRightElevatorPosition = 47.6;
    public static final double scoringPosition = 58.5;
    ...
    public static final double kP_Elevator = 0.95;
